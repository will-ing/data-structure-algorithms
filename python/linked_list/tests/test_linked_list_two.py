...
def test_greater():
    ...
    link7.append_to_end(7)
    link7.append_to_end(8)
    link7.append_to_end(10)
    actual = link7.kth(3)
    expected = 7
    assert actual == expected
...
def test_kth_len():
    link8 = LinkedLists()
    link8.append_to_end(1)
    link8.append_to_end(2)
    link8.append_to_end(3)
    link8.append_to_end(4)
    actual = link8.kth(4)
    expected = 1
    assert actual == expected
...
def test_kth_negative():
    link9 = LinkedLists()
    link9.append_to_end(-1)
    link9.append_to_end(-2)
    link9.append_to_end(-3)
    link9.append_to_end(-4)
    actual = link9.kth(3)
    expected = -2
    assert actual == expected
...
def test_kth_middle():
    linkmid = LinkedLists()
    linkmid.append_to_end(1)
    linkmid.append_to_end(2)
    linkmid.append_to_end(3)
    linkmid.append_to_end(4)
    linkmid.append_to_end(5)
    linkmid.append_to_end(6)
    actual = linkmid.kth(3)
    expected = 4
    assert actual == expected
